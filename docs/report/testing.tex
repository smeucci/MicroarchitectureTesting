...
Nel caso precedente, che implementa il test numero 3 sul sistema della copia difensiva. Se una delle asserzioni fallisce, il test fallisce e vengono mostrati i messaggi specificati.
